...
with_node \
  ...
  --target "/Users/owl/Desktop/GymPara/ios/Pods/Target Support Files/Pods-GymPara/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-asset" "expo-constants" "expo-file-system" "expo-font" "expo-image" "expo-keep-awake" "expo-system-ui"
